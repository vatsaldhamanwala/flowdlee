  ...
  return (
    <main className="min-h-screen bg-[#F7F8F4] text-[#1F2933]">
      <section className="mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 py-20 text-center">
        <Badge className="mb-6 bg-[#F0EEFA] text-[#8B7CCB] hover:bg-[#F0EEFA]">
          AI-ready workday planner
        </Badge>
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-[#6B7280]">
          Flowdlee helps IT professionals plan focused work, take healthier
          breaks, and understand their daily rhythm with smart reminders and
          AI-assisted planning.
        </p>

        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <Button className="h-12 rounded-xl bg-[#5C8D7B] px-8 text-white hover:bg-[#4E7B6A]">
            Start free
          </Button>

          <Button
            variant="outline"
            className="h-12 rounded-xl border-[#E5E7DF] bg-white px-8 text-[#1F2933]"
          >
            View demo
          </Button>
        </div>
